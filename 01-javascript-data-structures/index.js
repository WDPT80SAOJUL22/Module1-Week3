...
// objetos -> { key: 'value', key: 'value', key: 'value' }

// nested structures -- aninhada
...
students.push({name:'Walison', age: 12})
...
const schoolSystem = {
  ...
  console.log(schoolSystem.schools[1].classRooms[0].teacher.firstName)